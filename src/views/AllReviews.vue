...
<template>
  ...
  >
    <div class="w-full bg-[#F2F6FD] dark:bg-transparent flex flex-col items-center mb-[32px]">
      <div class="w-page px-[16px] md:px-0">
        <header class="py-[10.5px] flex justify-between items-center">
          <div class="flex gap-[42px] items-center">
            ...
            <form @submit.prevent="search" class="w-[778px]">
              <AppInput
                v-model="query"
                type="search"
        ...
        <div class="flex gap-[10px] overflow-x-auto pb-[16px]">
          <div
            class="text-center text-[14px] py-[4px] px-[8px] border-[0.2px] border-black dark:border-text-dark bg-white dark:bg-black-light rounded-[4px] cursor-pointer hover:opacity-75"
    ...
    <div class="w-page">Hi Welcome to my Youtube Tutorial</div>
  </section>
</template>
