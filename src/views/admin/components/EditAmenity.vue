...
const getAmenity = async function () {
  loading.value = true
  ...
  try {
    ...
    console.log(error)
    notify({ content: error.message ?? 'An error occurred', type: 'error', position: 'top-center' })
    router.go(-1)
  }
...
<template>
  <div class="md:w-2/3 text-left">
    ...
    <h1 class="text-icon dark:text-primary-light font-[500] text-2xl mt-5">Edit Amenity</h1>
    <form
